            ...
            return (
              <li key={item.href}>
                <Link
                  ...
                  className={`flex flex-col items-center gap-0.5 px-1.5 py-1 rounded-lg text-[9px] font-medium outline-none transition-colors focus-visible:ring-2 focus-visible:ring-green-600 ${
...
function NavIcon({ href, active }: { href: string; active: boolean }) {
  ...
  const icons: Record<string, React.ReactNode> = {
    '/dashboard': (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
