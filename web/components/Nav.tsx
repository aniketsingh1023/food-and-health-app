            ...
            return (
              <li key={item.href}>
                <Link
                  ...
                  className={`flex flex-col items-center gap-0.5 px-2 py-1 rounded-lg text-[10px] font-medium focus-visible:ring-2 focus-visible:ring-green-600 outline-none transition-colors ${
